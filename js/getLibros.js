...
async function getProductos() {
    ...
    try {
        const response = await fetch('./functions/getProductos.php', {
            ...
            body: JSON.stringify({ tipoDeProductoId: 1 })
...
if (document.getElementById("list-categoria-container-libros")) {
    let productos = await getProductos();

    generarListaProductos(productos['body'], "#list-categoria-container-libros");
}