        ...
        <div class="row">
                ...
                <div class="footer-item d-flex flex-column my-3">
                    ...
                    <span class="text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-envelope social-icon" viewBox="0 0 16 16">
                            <path
                                d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z" />
                        </svg> gonzalo.rigoni@davinci.edu.ar</span>
                    <a class="text-white" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-telephone social-icon" viewBox="0 0 16 16">
                            <path
                    ...
                    <div class="d-flex align-items-center">
                        <a href="./pages/404.html" class="btn-square rounded-circle" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <a class="btn-square rounded-circle mx-4" target="_blank"
                            href="https://www.linkedin.com/in/gonzalo-rigoni-4162b3274/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-linkedin social-icon" viewBox="0 0 16 16">
                                <path
            ...
            <div class="col-md-4">
                <div class="footer-item d-flex flex-column my-3">
                    ...
                    <a href="./pages/404.html" class=" text-white"> Sobre Nosotros</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="footer-item d-flex flex-column my-3">
                    ...
                    <a href="pages/404.html" class=" text-white"> Contacto</a>
                </div>
            </div>
            <div class="col d-flex justify-content-end">
                <xml version="1.0" encoding="utf-8">
                    <a href="https://davinci.edu.ar/"><svg width="300px" version="1.1" id="Capa_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                            y="0px" viewBox="380.1 375.4 329.1 92.4"
                            style="enable-background:new 380.1 375.4 329.1 92.4;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: #FFFFFF;
                                }
